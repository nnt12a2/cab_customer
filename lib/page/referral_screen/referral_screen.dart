...
class _ReferralScreenState extends State<ReferralScreen> {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "${"Earn".tr} ${Constant.currency}${double.parse(referralController.referralAmount.toString()).toStringAsFixed(int.parse(Constant.decimal.toString()))} ${"each".tr}",
                                style: const TextStyle(
                                    fontSize: 22,
                                    color: Colors.white,
  ...
  Future<void> share(ReferralController referralController) async {
    ...
    await FlutterShare.share(
      title: 'Cabme',
      text:
          'Hey there, thanks for choosing Cabme. Hope you love our product. If you do, share it with your friends using code ${referralController.referralCode.toString()} and get ${Constant.currency}${double.parse(referralController.referralAmount.toString()).toStringAsFixed(int.parse(Constant.decimal.toString()))} when ride completed',
    );
  }
}
