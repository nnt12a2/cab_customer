                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text('${Constant.currency.toString()} ${double.parse(controller.data.value.montant.toString()).toStringAsFixed(int.parse(Constant.decimal ?? "2"))}',
                            ...
                            Row(
                              children: [
                                ...
                                Text('(-)${Constant.currency.toString()} ${controller.discountAmount.value.toStringAsFixed(int.parse(Constant.decimal ?? "2"))}',
                                    style: TextStyle(letterSpacing: 1.0, color: ConstantColors.titleTextColor, fontWeight: FontWeight.w800)),
                              ],
                            ),
                            Padding(
                            ...
                            Row(
                              children: [
                                ...
                                Text('${Constant.currency.toString()} ${controller.taxAmount.value.toStringAsFixed(int.parse(Constant.decimal ?? "2"))}',
                                    style: TextStyle(letterSpacing: 1.0, color: ConstantColors.titleTextColor, fontWeight: FontWeight.w800)),
                              ],
                            ),
                            Visibility(
